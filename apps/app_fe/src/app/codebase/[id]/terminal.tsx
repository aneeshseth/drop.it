...
export default function TerminalComponent(props: {
  current_socket: WebSocket | null, onUpdate: any
}) {
  ...
  function checkMakeOrRemoveDir() {
    const enteredCommand = currentCommands.current.map(command => command.key).join('');
